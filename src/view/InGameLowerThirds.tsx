...
import LowerThirdsAlt, {
  getLTWidth,
  LowerThirdsSize,
} from "../comps/lowerthirds/LowerThirdsAlt";
import {
  ReduxState,
  LowerThirdsMode,
  Participant,
...
const IngameLowerThirds: React.FC<RouteComponentProps> = ({
  location: { search },
}) => {
  const c = ms();
  const {
    lowerThirdsIngame: lowerThirds,
    casters,
    casters_alt,
    match,
    tournament,
  ...
  return (
    <div className={c.screen}>
      ...
      <Transition
        items={Boolean(lowerThirds?.is_live)}
                      ...
                      <div className={c.playerStats}>
                        ...
                        <div className="content">
                          ...
                          <div className="stats">
                            ...
                            <div className="statItem">
                              <div className="property">
                                {lowerThirds?.player_stats?.middle?.property}
                              </div>
                              <div className="value">
...
export default withRouter(IngameLowerThirds);
